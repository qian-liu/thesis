...
Synaptic Sampling Machines (S2Ms)~\cite{neftci2016stochastic} employing a dropout~\cite{srivastava2014dropout} mechanism hugely improved the performance of its original model from 91.9\% to 95.6\%.
