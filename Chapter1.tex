...
%	\textbf{A generalised SNN training method to train an equivalent ANN and transfer the trained weights back to SNNs.}
	...
	The core elements of the training methods are a pair of novel activation functions used in ANNs: the Noisy Softplus~(NSP) and the Parametric Activation Function~(PAF).
	...
	The proposed activation functions completely solve the problem of the fundamental differences in data representation and neural computations between ANNs and SNNs, thus tackle the difficulties of transforming ANN models to SNNs.
...
%	It was tested on a convolutional network and showed a recognition capability a close to the conventional ANN. 
	...
	In addition, the numerical analysis of the proposed algorithm accurately estimate the parameters thus closely mimics the learning behaviour of the AE and RBM modules and improves the learning performance compared to existing methods.
...
\section{Summary}
	...
	Chapter~\ref{cha:intro} introduces that NE aims at brain modelling and building brain-like machines.
