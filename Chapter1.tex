...
However, the SNN has not achieved the intelligent performance of its non-spiking counterpart, the ANN, particularly when used in deep neural networks.
%TODO Current status
...
Therefore, researchers turn to Deep Learning for building intelligent SNNs.
Initial studies have shown that SNNs can be trained by first training an equivalent deep ANN and then transferring the trained weights to the SNN.
