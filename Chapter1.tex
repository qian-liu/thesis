...
How to embed deep learning techniques in spiking neural networks to close the performance gap between SNNs and ANNs in cognitive tasks?

Thesis Statement:
Although SNN training in general is believed to be difficult, combining deep learning with spiking neurons thus to train SNNs of deep architectures can be simple, effective and generalised. % because existing approaches have shown promising results in the early stage of the study.
