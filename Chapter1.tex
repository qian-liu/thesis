...
%	This work comprises Chapter 3 and was published and presented to the International Conference on Artificial Neural Networks 2015.
	...
	\item 
	A novel activation function, Noisy Softplus, to accurately model the neural response activity of spiking neurons.
	It enables off-line SNN to be trained just like ANNs, and the trained weights can be directly use in SNNs without any conversion.
...
% and reviews the state-of-the-art of spike-based object recognition applications. 
