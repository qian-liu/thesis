...
%TODO rewording
A commonly used max pooling of $2\times2$, shown in Figure~\ref{Fig:ConvNet}, moves the kernel traverse over the feature map of the previous layer with the stride of 2, and puts the largest (or averaged) element of each receptive field to the next feature map.
