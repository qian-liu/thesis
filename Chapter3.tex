\chapter{Pattern-Based Recognition-Paper 1 \& 2}
\label{cha:pattern}
...
\subsection{The Neuromorphic Platform}
\label{sec:np}
...
\subsubsection{SpiNNaker System}
...
\begin{figure}
\centering
	\includegraphics[width=0.42\textwidth]{pics_icann/mesh_ctiff.jpg}
...
\subsubsection{Interfacing AER Sensors}
...
\begin{figure}
\centering
	\includegraphics[width=0.42\textwidth]{pics_icann/conv.pdf}
...
\begin{figure}
\centering
	\includegraphics[width=0.8\textwidth]{pics_icann/model1.pdf}
	\caption{Model 1. 
...
\begin{figure}
\centering
	\includegraphics[width=0.8\textwidth]{pics_icann/gesture.pdf}
...
\begin{figure}
\centering
	\includegraphics[width=0.8\textwidth]{pics_icann/gabor.pdf}
...
\begin{figure}
\centering
	\includegraphics[width=0.8\textwidth]{pics_icann/model2.pdf}
	\caption{Model 2. 
...
\begin{figure}
\centering
	\includegraphics[width=0.8\textwidth]{pics_icann/rateMatlab.pdf}
...
\subsection{Real-Time Recognition on SpiNNaker}
\subsubsection{Live Recognition}
...
\subsubsection{Recognition of Recorded Data}
...
\begin{figure}
\centering
	\includegraphics[width=0.8\textwidth]{pics_icann/rateSpiNN.pdf}
...
\section{Plasticity in Learning Patterns}
...
Later in Section~\ref{subsec:model}, CA, response time (latency) and the total number of synaptic events are the main concerns when assessing the recognition performance.
...
%	}
	\includegraphics[width=0.8\textwidth]{pics_bench/fig7_m}
...
\begin{figure}[hbt!]
	\centering
	\includegraphics[width=0.6\textwidth]{pics_bench/fig8}
