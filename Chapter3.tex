...
Current trend of deep learning is to combine other machine learning algorithms to work on other objectives: decision making and generative models.
...
\subsubsection{Reinforcement learning}~\cite{mnih2015human}
...
\subsubsection{Generative Adversarial Networks (GAN)}~\cite{goodfellow2014generative}


\subsubsection{Attention Model}~\cite{bahdanau2014neural}
...
Multiple AEs can be stacked up to build deep AEs where the hidden layer of a lower AE represents the input of the upper block, and each AE block can be trained individually with greedy layer-wise training~\cite{hinton2006fast}.
