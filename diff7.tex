...
Thanks to the \DIFdelbegin \DIFdel{formalisation }\DIFdelend \DIFaddbegin \DIFadd{accurate parameter estimation }\DIFaddend of these proposed learning algorithms\DIFdelbegin \DIFdel{with numerical analysis}\DIFdelend , the classification results (94.72\% for SAE and 94.35\% for SRBM) have outperformed other existing SAE and SRBM models.
...
\DIFdelbegin \DIFdel{Meanwhile, other }\DIFdelend \DIFaddbegin \DIFadd{Therefore, this method enables the genuine `live and learn' in }\DIFaddend on-line \DIFdelbegin \DIFdel{training }\DIFdelend \DIFaddbegin \DIFadd{SNN training;
meanwhile, other }\DIFaddend methods~\citep{neftci2016stochastic,neftci2017event} suffer from the manual termination of \DIFdelbegin \DIFdel{the learning }\DIFdelend \DIFaddbegin \DIFadd{learning when the performance reaches the best}\DIFaddend .
