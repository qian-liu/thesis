...
This proposed SNN training method is simpler and even more straight-forward than the other ANN-based training approach~\citep{cao2015spiking,diehl2015fast} which requires an extra step of converting ANN-trained weights \DIFdelbegin \DIFdel{to SNN's}\DIFdelend \DIFaddbegin \DIFadd{for use at the SNN}\DIFaddend .
