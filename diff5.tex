...
\cite{neil2013online,neftci2013event} }%DIFAUXCMD
without describing it clearly.
It typically refers to an event-based SNN system, where the learning occurs when a spike arrives under some certain condition.
