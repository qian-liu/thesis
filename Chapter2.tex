...
%\label{sec:stl}
This chapter aims to introduce fundamental concepts of spiking neurons, which are the basic processing units of SNNs, and all the proposed work in the thesis will be built on such units.
