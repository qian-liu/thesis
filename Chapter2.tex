...
Nevertheless, our experimental results show that the network using unbiased neurons performs the same when it is used to solve a relatively simple task, the MNIST. 
%The bias deduction does not bring down the performance of these neural network models, since they provide enough parameters for the particular MNIST tasks.
