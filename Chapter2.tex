...
\begin{figure}[tb!]
	...
	\caption{Membrane potential evolves as a Resistor-Capacitor (RC) circuit~\citep{gerstner2014neuronal}.}
	\label{Fig:rc}
\end{figure}
...
However, these hardware SNN simulators either run on FPGAs~\citep{neil2014minitaur, kiselev2016event} or analogue circuits~\citep{qiao2015reconfigurable} and are limited in scale.
	...
	\end{subfigure}
	\caption[Neuromorphic hardware system using SpiNNaker.]{Three set-ups of neuromorphic sensory and processing hardware platform using SpiNNaker.}
