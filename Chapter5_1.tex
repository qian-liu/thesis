...
The average reconstruction loss is also worse than S1 and S2, similar to SAE test, because of the bias. 
...
\section[Results]{Results: MNIST Test}
...
Although, \citet{neftci2016stochastic} keep the state-of-the art accuracy of 95.6\%, they exploited the edge tool, dropout and more training epochs, but did not report the comparison to the corresponding non-spiking RBM-dropout.
