...
Furthermore, we put forward solutions to reduce correlations between spike trains; thereby to address the result of performance drop in on-line training. 
