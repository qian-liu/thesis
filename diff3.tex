...
Deep Learning \DIFdelbegin \DIFdel{seems to have }\DIFdelend \DIFaddbegin \DIFadd{has }\DIFaddend become the answer to \DIFdelbegin \DIFdel{all }\DIFdelend \DIFaddbegin \DIFadd{increasing number of }\DIFaddend artificial intelligence problems \DIFdelbegin \DIFdel{overnight }\DIFdelend since Geoffrey Hinton \DIFaddbegin \DIFadd{firstly }\DIFaddend proposed the training method of \DIFdelbegin \DIFdel{a type of ANN, }\DIFdelend the Deep Belief Network, in 2006~\citep{hinton2006fast}.
