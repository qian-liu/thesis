...
\begin{figure}
	...
	\begin{subfigure}[c]{0.45\textwidth}\raggedleft
		...
		\caption{Exp2 Loss}
	\end{subfigure}%
	\caption{Comparisons of weights and loss of solutions for training SAEs of LIF neurons. To accelerate the training at the beginning, the initial weights are random chosen ranging from [0, 0.1]. 10 visible units fully connected to 10 hidden units with Poisson spike trains of firing rate ranging from 10~Hz to 100~Hz.}
	\label{fig:LIF_sae}
\end{figure}
...
\begin{figure}
	...
	\begin{subfigure}[c]{0.45\textwidth}\raggedleft
		...
		\caption{Exp2 Loss}
	\end{subfigure}%
	\caption{Comparisons of weights and loss of solutions for training SRBMs of LIF neurons. To accelerate the training at the beginning, the initial weights are random chosen ranging from [0, 0.1]. 10 visible units fully connected to 10 hidden units with Poisson spike trains of firing rate ranging from 10~Hz to 100~Hz.}
	\label{fig:LIF_srbm}
\end{figure}
