Neuromorphic Engineering~(NE) has led to the development of biologically-inspired computer architectures \DIFdelbegin \DIFdel{which may }\DIFdelend \DIFaddbegin \DIFadd{whose long-term goal is to }\DIFaddend approach the performance of the human brain in terms of energy efficiency and cognitive capabilities.
