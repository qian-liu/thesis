...
\DIFaddbegin \DIFadd{Nevertheless, our experimental results show that the performance almost keeps the same when solving a relatively simple task, the MNIST. 
