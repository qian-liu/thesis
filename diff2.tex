...
The communication bandwidth is therefore optimised by sending activity only, which is encoded as pixel events using \DIFaddbegin \DIFadd{the }\DIFaddend AER~\citep{lazzaro1995multi} protocol.
