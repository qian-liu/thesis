...
\begin{figure}[tb!]
	...
	\caption{\DIFaddFL{Current flowing into a neuron functions like a Resistor-Capacitor (RC) circuit~\mbox{%DIFAUXCMD
...
However, these hardware SNN simulators either run on FPGAs~\citep{neil2014minitaur, kiselev2016event} or analogue circuits~\citep{qiao2015reconfigurable} and are limited in scale.
	...
	\end{subfigure}
	\DIFdelbeginFL %DIFDELCMD < \caption{%%%
\DIFdelendFL \DIFaddbeginFL \caption[Neuromorphic hardware system using SpiNNaker.]{\DIFaddendFL Three set-ups of neuromorphic sensory and processing hardware platform using SpiNNaker\DIFdelbeginFL \DIFdelFL{~\mbox{%DIFAUXCMD
