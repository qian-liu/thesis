...
%shows the parameters (described in~\cite{sen2009evaluating}) used to compute the convolution kernels at each 
%scale $w$.
%
%
%
...
\begin{table*}[hbt!] \small 
	...
	\begin{center}
		...
		\begin{tabular}{ l c c c c }
			...
			\begin{mycell}{2cm} Normalisation \end{mycell} & % preprocessing
			\begin{mycell}{3cm} Two layer, LIF neurons\end{mycell}&  % network
			...
			\begin{mycell}{2cm} Thresholding,\\ Synaptic current\end{mycell} & % preprocessing
			\begin{mycell}{3cm} Two layer RBM, \\ LIF neurons \end{mycell}&  % network
			...
			\begin{mycell}{3cm} Unsupervised, STDP,\\ %adaptive membrane potential, 
			...
			\begin{mycell}{3cm} ConvNet or \\Fully connected,\\ LIF neurons \end{mycell}& % network
			\begin{mycell}{3cm} Off-line trained with ReLU, weight normalisation \end{mycell}&   % training
			\begin{mycell}{3cm} 99.1\% (ConvNet), \\ 98.6\% (Fully connected);\\0.5~s per test\end{mycell}\\ % recognition    
			%
			...
			%
			\begin{mycell}{0.5cm} % %\cite{Stromatias2015scalable} \\ 
				This paper \end{mycell} & 
			\begin{mycell}{2cm} Poisson \end{mycell} & % preprocessing
			\begin{mycell}{3cm} Four layer RBM, \\ LIF neurons \end{mycell}&  % network
			...
			%
			\begin{mycell}{0.5cm} This paper \end{mycell}  & 
			\begin{mycell}{2cm} Poisson \end{mycell}& % preprocessing 
			...
			\begin{mycell}{3cm} 92.99\%\\1~s per test\\0.2~s blank \\13.82~ms latency\\$4.17$M Sopbs\end{mycell} % recognition
		\end{tabular}
		\egroup
	\end{center}
...
%\cite{Diamond2016comparing} compared the power usage and simulation time on three hardware platforms in detail regarding to all the stages while this paper focuses on the simulation part only.
