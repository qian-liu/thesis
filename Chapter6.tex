...
%			\begin{mycell}{3cm} 91.6\% \\ 300~ms per test \end{mycell} \\% recognition
			...
			\begin{mycell}{2cm}Poisson\end{mycell} & % preprocessing
			\begin{mycell}{3cm} Five layers,\\ConvNet, \\IF neurons\end{mycell}& % network
			...
			\begin{mycell}{2cm}Poisson\end{mycell} & % preprocessing
			\begin{mycell}{3cm} Five layers,\\ConvNet, \\LIF neurons\end{mycell}& % network
			\begin{mycell}{3cm} Off-line trained with ReLU,\\ Noisy Softplus fine-tune\end{mycell}&   % training
			\begin{mycell}{3cm} 98.85\%, \\1~s per test\\$53.4$M Sopbs\end{mycell}\\ % recognition    
