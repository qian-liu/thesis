...
In the previous chapter we have argued that deep Spiking Neural Networks~(SNNs) are equally capable of classifying digits as are deep Artificial Neural Networks~(ANNs), and can be trained simply off-line on an equivalent ANN.
