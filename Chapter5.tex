...
It is surprising to see that the original SRM training performs the best in both SAE and SRBM models.
...
The proposed Spike-based Rate Multiplication (SRM) and its improving solutions formalise a local learning algorithm based on STDP and have been applied to train spiking AEs and RBMs.
...
The promising results exhibit equivalent and even surpassing classification and reconstruction capabilities of SAEs and SRBMs.
In addition, the spike-based models can be implemented on neuromorphic systems in a very energy-efficient manner.
