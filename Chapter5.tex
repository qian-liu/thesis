\chapter{Spiking Deep Belief Network-Paper 4*}
\label{cha:sdbn}
...
\section{Mapping trained DBN to SNN}
As Chapter \ref{cha:Conv} stated, we mapped trained DBN to SNN.
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.4\textwidth]{pics_ae/AE.pdf}
