...
\begin{tabular}{c l l}
	%\hline
	K & SAE firing rate & SRBM firing rate\\
	\hline
	10 & $1.92 \times 10^3$ & $2.46 \times 10^3$ \\
	50 & $8.66 \times 10^3$ & $1.24 \times 10^4$  \\
	100 & $1.66 \times 10^4$ & $2.43 \times 10^4$ \\
	500 & $7.43 \times 10^4$ & $1.07 \times 10^5$ \\
\end{tabular}
\egroup
\end{table}


The energy use for classifying the whole testing images can be estimated more accurately as: $Number\_of\_images \times Mean\_firing\_rate \times Time\_per\_image \times Energy\_per\_spike$.
The $Mean\_firing\_rate$ for various $K$ values is listed in Table~\ref{tbl:fire_rate}.
...
In all SAEs are more suitable for SNN training than SRBMs.
