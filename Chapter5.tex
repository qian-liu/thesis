...
%TODO What, Why, How
The deep learning models selected in the research are Autoencoders (AE) and Restricted Boltzmann Machine (RBM) due to their unsupervised learning mechanism and popularity.
\section{Introduction}
Specify the motivation and state of the art
