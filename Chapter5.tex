...
It is crucial in not only building SNNs for object recognition applications, but also equipping the deep SNN models with learning capability.
...
cess. In 1999, Hinton and Brown~\cite{brown2000spiking} investigated using sigmoids that spike over time
...
and Hinton~\cite{teh2001rate} applied contrastive divergence to continuously-valued face images using
...
A significant advance was made when O’Connor proposed~\cite{o2013real} using a rate-based model
...
%critisize
Following Wolfgang Mass on neural sampling.
...
%4. remote (ReSuMe)
Mostly inspired from this work~\cite{ponulak2010supervised}.
