...
This mechanism is known as \DIFdelbegin \DIFdel{synaptic time-dependant plasticity }\DIFdelend \DIFaddbegin \DIFadd{spike-time-dependent-plasticity }\DIFaddend (\textbf{STDP})~\citep{song2000competitive}, and the standard STDP learning window is illustrated in Figure~\ref{Fig:STDP}:
\begin{equation}
\Delta w = \left\{
\begin{aligned}
