...
\DIFdelFL{mV }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{~mV }& \DIFaddFL{membrane threshold  }\DIFaddendFL \\
				%\hline
				\DIFdelbeginFL \DIFdelFL{i\_offset }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$I_{\textit{\textrm{offset}}}$ }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.1 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0~nA }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{nA}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{offset of current influx  }\DIFaddendFL \\
...
%\end{figure}
	...
	\begin{figure}[tbp!]
		...
		\begin{subfigure}[t]{0.49\textwidth}
			\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{pics_iconip/2-1.png}
%DIFDELCMD < 			%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{pics_iconip/revise_2-1.png}
		...
		\end{subfigure}
		\begin{subfigure}[t]{0.49\textwidth}
			\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{pics_iconip/2-10.png}
%DIFDELCMD < 			%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{pics_iconip/revise_2-2.png}
		...
		\end{subfigure}
		\caption[Recorded response firing rate driven by \textit{NoisyCurrentSource}.]{Recorded response firing rate of an LIF neuron driven by \textit{NoisyCurrentSource} in PyNN, sampled at every (a) 1~ms and (b) 10~ms. Averaged firing rates of 10 simulation trails are shown in \DIFdelbeginFL \DIFdelFL{bold }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{dashed }\DIFaddendFL lines, and the grey colour fills the range between the minimum to maximum of the firing rates. The analytical LIF response function, the Siegert formula (Equation~\ref{equ:siegert}), is drawn in \DIFdelbeginFL \DIFdelFL{thin }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{bold }\DIFaddendFL lines (shown in Figure~\ref{Fig:physics}) to compare with the practical simulation.}
		\label{Fig:current}
	\end{figure}
	...
	The differences relative to the analytical results (\DIFdelbegin \DIFdel{thin }\DIFdelend \DIFaddbegin \DIFadd{bold }\DIFaddend lines) is due to the time resolution, $dt$, of the \textit{NoisyCurrentSource}.
	...
	Although both current signals follow the same Gaussian distribution, see Figures~\ref{Fig:lif_curr}~(g) and (h), the current is \DIFaddbegin \DIFadd{approximately }\DIFaddend a white noise when $dt=1$~ms, but a coloured noise, e.g. increased Power Spectral Density~(PSD) at lower frequency, when $dt=10$~ms, see Figures~\ref{Fig:lif_curr}~(c) and (d).
...
%\end{figure}
	...
	\begin{figure}[tbp!]
		\centering
		\begin{subfigure}[t]{0.49\textwidth}
			\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{pics_iconip/spiked_curve_1.png}
%DIFDELCMD < 			%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{pics_iconip/revise_spike_curve-1.png}
		...
		\end{subfigure}
		\begin{subfigure}[t]{0.49\textwidth}
			\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{pics_iconip/spiked_curve_10.png}
%DIFDELCMD < 			%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{pics_iconip/revise_spike_curve-2.png}
		...
		\end{subfigure}
		\caption[Recorded response firing rate driven by a synaptic current.]{Recorded response firing rate of an LIF neuron driven by a synaptic current with two synaptic time constants: (a) $\tau_{\textit{\textrm{syn}}}$=\DIFdelbeginFL \DIFdelFL{10}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{1}\DIFaddendFL ~ms and (b) $\tau_{\textit{\textrm{syn}}}$=10~ms. Average firing rates of 10 simulation trails are shown in \DIFdelbeginFL \DIFdelFL{bold }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{dashed }\DIFaddendFL lines, and the grey colour fills the range between the minimum to maximum of the firing rates. The firing rates recorded driven by \textit{NoisyCurrentSource} are drawn in \DIFdelbeginFL \DIFdelFL{thin }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{bold }\DIFaddendFL lines (shown in Figure~\ref{Fig:lif_curr}) for comparison.}
		\label{Fig:spike_curr}
	\end{figure}

	\begin{figure}[tbp!]
		\centering
		\makebox[0.43\textwidth]{$\tau_{\textit{\textrm{syn}}}$=1~ms} \makebox[0.43\textwidth]{$\tau_{\textit{\textrm{syn}}}$=10~ms} \par
		\begin{subfigure}[t]{0.43\textwidth}
			\includegraphics[width=\textwidth]{pics_iconip/curr_tau1.pdf}
			\caption{Current \DIFdelbeginFL \DIFdelFL{sampled at $dt$=1~ms}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{generated by spikes}\DIFaddendFL .}
		\end{subfigure}
		\begin{subfigure}[t]{0.43\textwidth}
			\includegraphics[width=\textwidth]{pics_iconip/curr_tau10.pdf}
			\caption{Current \DIFdelbeginFL \DIFdelFL{sampled at $dt$=10~ms}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{generated by spikes}\DIFaddendFL .}
		\end{subfigure}\\
		\begin{subfigure}[t]{0.43\textwidth}
...
%	Thus the experiments show that a longer $\tau_{\textit{\textrm{syn}}}$ increases the level of noise and widens the variance of the output firing rate.
...
\DIFdelendFL \DIFaddbeginFL \begin{figure}[bht!]
		...
		\begin{subfigure}[t]{0.48\textwidth}
			\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{pics_iconip/siegert.png}
%DIFDELCMD < 			%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{pics_iconip/revise_siegert.png}
		...
		%DIF > 		\end{subfigure}\\
		\begin{subfigure}[t]{0.48\textwidth}
			\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{pics_iconip/4.pdf}
%DIFDELCMD < 			%%%
...
%DIF < 	However, such a derivative function of low complexity does not present in Siegert function.
	...
	%DIFAUXCMD
\DIFdel{where $\lambda_i$ indicates the firing rate of an input spike train}\DIFdelend \DIFaddbegin \DIFadd{$m_I$ and $s_I^2$.
...
%DIF > 	\end{equation}
%DIF > 	where $\lambda_i$ indicates the firing rate of an input spike train.
	Since the NSP takes two variables as inputs, the activation function can be plotted in 3D, see Figure~\ref{Fig:NSP3D}}\DIFaddend .
...
%DIFDELCMD < 		%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.7\textwidth]{pics_iconip/revise_5.pdf}
...
%DIF < 	The result of fine tuning on a ConvNet will be demonstrated in Section~\ref{subsec:result_compare}.
	...
	\DIFaddbegin \begin{figure}
		...
		\end{subfigure}
		\caption[NSP fits to the response firing rates.]{\DIFaddFL{NSP fits to the response firing rates of LIF neurons in concrete physical units.
...
\DIFdelFL{NSP fits to the response firing rates of LIF neurons in concrete physical units.
			Recorded response firing rate of an LIF neuron driven by synaptic current with two synaptic time constants: (a) $\tau_{\textit{\textrm{syn}}}$=1~ms and (b) $\tau_{\textit{\textrm{syn}}}$=10~ms. Averaged firing rates of simulation trails are shown in bold lines, and the grey colour fills the range between the minimum to maximum of the firing rates. The thin lines are the scaled NSP.}}
		%DIFAUXCMD
%DIFDELCMD < %DIFDELCMD < \label{Fig:nsptau1}%%%
...
\DIFdelend \begin{equation}
	...
	The derivative function of PAF}\DIFaddend , which is used for back propagation, is:
	\begin{equation}
...
\end{sidewaystable*}
	...
	\begin{figure}[htb!]
		\centering
		\begin{subfigure}[t]{0.49\textwidth}
			\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{pics_iconip/8-2.png}
%DIFDELCMD < 			%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{pics_iconip/revise_8-2.png}
		...
		\end{subfigure}
		\begin{subfigure}[t]{0.49\textwidth}
			\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{pics_iconip/8-3.png}
%DIFDELCMD < 			%%%
