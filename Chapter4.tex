...
%\end{figure}
	...
	To verify the response function in practice, simulation tests were carried out using PyNN~\cite{davison2008pynn} to compare the reality with the analytical results~(the Siegert function).
