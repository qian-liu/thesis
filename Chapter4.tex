...
An intuitive idea of bringing these Deep Learning techniques to spiking neural networks~(SNNs) is either transferring well-tuned deep ANN models into SNNs or translating numerical calculations of weight modulation to biologically-plausible synaptic learning rules.
