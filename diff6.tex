...
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.7\textwidth]{pics_bench/fig6.jpg}
	\caption[SNN model of the case study.]{\DIFaddendFL The (a) training and (b) testing model of the \DIFdelbeginFL \DIFdelFL{two-layered spiking neural network}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{proposed case study SNN: STDP learning with supervised teaching signal}\DIFaddendFL .}
	\label{fig:model}
\end{figure} 
