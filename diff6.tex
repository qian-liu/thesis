			...
			\begin{savenotes}
				...
				\begin{tabular}{l c c c c c c}
					...
					\begin{mycell}{2.2cm}122 bits \\params \& states,
						%       	 per neuron
						\\4-bit/\\4 values\\synapses%DIF < \\(4 signed int + on/off state)
%						\DIFdelbegin \footnote[1]{\DIFdel{We consider them 4-bit synapses because it is only possible to choose between 4 different signed integers and whether the synapse is active or not.}}
					%DIFAUXCMD
\addtocounter{footnote}{-1}%DIFAUXCMD
\DIFdelend \DIFaddbegin \footnotemark[1]
					...
					%DIFAUXCMD
\addtocounter{footnote}{-1}%DIFAUXCMD
\DIFdelend \DIFaddbegin \footnotemark[2]
					\DIFaddend \end{mycell}&
	...
	\DIFaddbegin \footnotetext[1]{\DIFadd{We consider them 4-bit synapses because it is only possible to choose between 4 different signed integers and whether the synapse is active or not.}}
	\footnotetext[2]{\DIFadd{A maximum speed-up of up to $10^5$ times real time has been reported.}}
