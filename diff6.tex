...
\begin{figure}[bht!]
	...
	\caption[Snapshots of the jAER software.]{
		...
		The same image of digit `0' is transformed into spikes by \DIFaddbeginFL \DIFaddFL{DVS recording and Poisson generation, where }\DIFaddendFL (a) \DIFdelbeginFL \DIFdelFL{DVS recording }\DIFdelendFL and (b) \DIFdelbeginFL \DIFdelFL{Poisson generation}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{show the snapshots of the jAER software.
		They visualise the spike counts for each pixel of an image}\DIFaddendFL .
